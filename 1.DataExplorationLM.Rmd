...
From this [source](https://www.cs.toronto.edu/~delve/data/boston/bostonDetail.html) The dataset is derived from information collected by the U.S. Census Service concerning housing in the area of Boston Mass.
...
dev.off()
```
Model validation is not perfect. We can observe skewd residuals to positive in the lower end of values, and we have some outliers (153, 156, 157).
...
**MAYBE TRY USING THE BOOT ?**

## Conclusions
Dataset             | Test R^2       | Test MSE | Test/Train MSE ratio
----------          | ---            | ---      | --- 
Normal              | per            | Test MSE | Test MSE
Scaled              | per            | Test MSE | Test MSE
Scaled trans. "crim"| per            | Test MSE | Test MSE
```{r, message=FALSE, warning=FALSE}
